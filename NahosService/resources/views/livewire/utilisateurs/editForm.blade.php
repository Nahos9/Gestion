    ...
    <div class="col-md-6">
        ...
        <div class="card card-primary">
            ...
            <div class="card-footer">
                ...
                <button type="button" wire:click="goToUser()" class="btn btn-danger">Retouner à la liste des utilisateurs</button>
            </div>
            </form>
        </div>
        <!-- /.card -->
                                    ...
                                    <div class="card">
                                        <div class="card-header d-flex justify-content-between">
                                            ...
                                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                                ...
                                                <input type="checkbox" class="custom-control-input " wire:model.lazy="rolesPermissions.roles.{{$loop->index}}.active"
                                                     @if ($role["active"])
                                                         checked
                                                     @endif
